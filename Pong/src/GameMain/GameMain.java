...
public class GameMain extends Canvas implements Runnable{
    ...
    private void tick() {
    	/*
    	 * f�hre Berechnungen aus f�r Objekte und HUD
    	 */
    		handler.tick();
    		hud.tick();
	}
	...
	public static float clamp(float var, float min, float max) {
		/*
		 * Werte Begrenzer
		 * setzt zu gro�e Werte auf mitgegebenen max Wert
	...
	public void run() {
		 ...
		 * Game-Loop
		 * FPS: unbegrenzt
		 * f�hre in gleichmaesigen Abstaenden die Methoden tick und render aus
